...
import { test as salesMasterDataTest } from './salesMasterData.fixtures';

export { expect } from '@playwright/test';

/** Merged test object that includes all fixtures: rpc + hrMasterData + salesMasterData */
export const test = mergeTests(baseTest, masterDataTest, salesMasterDataTest);
...
export type { SalesMasterData, SalesMasterDataWorkerFixtures } from './salesMasterData.fixtures';
